...
# ... (previous code for loading and preprocessing MNIST remains unchanged)
...
# ... (rest of the code for compilation, training, evaluation, and prediction remains unchanged)
