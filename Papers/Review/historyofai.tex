...
The origins of AI trace back to Aristotle (384-322 B.C.), who introduced deductive reasoning through syllogisms. Ramon Llull (ca. 1235-1316) contributed with his Ars Magna, a conceptual machine designed to answer all questions. Earlier thinkers such as Aristotle, Leibniz, Babbage, and Hollerith laid the groundwork for AI, influencing its theoretical and practical developments.
...
\item 
In October 2015, Tesla's software update brought Autopilot to the public, introducing semi-autonomous features like lane centering and traffic-aware cruise control in Tesla cars.
\end{itemize}
...
\subsection{GPT-2 and T-NLG (2019)}
\begin{itemize}
...
\section{OpenAI Revolutionized: AI Hype-Race, Building AGI? (2020 - Present)}
\begin{itemize}
    \item \textbf{2020:}
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Future of AI and AGI:} AGI (Artificial General Intelligence) is a theoretical form of AI capable of performing any intellectual task a human can. Unlike narrow AI, which is task-specific, AGI would learn, reason, and solve problems across multiple domains autonomously. With continued advancements, companies remain focused on achieving AGI, raising ethical concerns about automation's impact on labor markets, privacy, and society. The race toward AGI continues, with breakthroughs expected to reshape industries and human life fundamentally.
    \end{itemize}
\end{itemize}
...
\section{Exploring Historical Events and Facts}

Whether philosophical, mechanical, or digital, there were many historical attempts to make machines intelligent. In the ancient era, philosophers and critical thinkers have given thought and tried to decipher the intelligent machine. "Machine intelligence,” "Cognology,” and "Artificial Intelligence” are the proposed names for the field. We will be calling Machine Intelligence instead of Artificial intelligence if the term "Artificial Intelligence" is not chosen and accepted. Twentieth-century logicians like Kurt Gödel, Stephen Kleene, and Alan Turing clarified the limits of logical and computational systems. While some philosophers viewed these limitations as evidence that human intelligence could not be mechanized. most logicians and computer scientists believe that these limitations apply to both humans and machines.

In the past, AI research captured significant attention on human intelligence's various capabilities, including visual perception and language comprehension. It was predicted that there would likely be a greater focus on integrated autonomous systems—robots and "softbots. " Softbots, or software agents, navigate the Internet to discover relevant information for users. The continuous drive to enhance the capabilities of robotic and software agents will shape the future of AI research for years to come. Now, in 2024, we can see chatbots, LLMs, customer service, and virtual assistants acting as intelligent agents.
...
The period from 1952 to 1969, referred to by John McCarthy as the “Look, Ma, no hands!” era, marked significant early successes in artificial intelligence, with many initial challenges being addressed. During this time, advancements in formal grammar, rooted in early 20th-century logic, introduced new approaches to language theories in linguistics.


In the 1950s, electronic stored-program digital computers became commercially viable, following prototypes like the Mark I, ENIAC, EDVAC, and UNIVAC. Key developments for AI included Claude Shannon's information theory, psychological neurological models, and advances in Boolean algebra, switching theory, and statistical decision theory. AI's foundation also draws on centuries of research from influential figures like Aristotle, Leibnitz, Babbage, and Hollerith, whose contributions paved the way for modern AI.

In the late 1950s, several significant AI projects emerged, including GPS (a general problem solver), a Geometry Theorem-Proving Machine (which developed proofs from basic axioms), and EPAM (designed for pattern recognition and memory, learning stimulus-response pairs through repetition).
...
Early machine translation efforts received significant funding from the U.S. National Research Council to accelerate the translation of Russian scientific papers after the 1957 Sputnik launch. However, challenges arose, exemplified by the famous mistranslation of "the spirit is willing but the flesh is weak" as "the vodka is good but the meat is rotten."
In the 1960s and early 1970s, AI research focused on problem representation, search techniques, and heuristics to develop computer programs capable of solving puzzles, playing games, and retrieving information.


From 1966 to 1973, AI researchers, including Herbert Simon, predicted rapid advancements in machine capabilities. Simon stated in 1957 that machines could think, learn, and create, expecting them to solve problems like the human mind within a "visible future." He anticipated that a computer would become a chess champion and prove significant mathematical theorems within ten years. While some predictions eventually came true, it took around 40 years instead of the projected ten, as early AI systems struggled with complex challenges. \\
...
In the 1990s, this trend began to reverse, with machine learning tools proving effective for many problems, leading to significant benefits from the reintegration of AI technologies.

From the 1990s to the present, AI and robotics have undergone significant evolution. Expert systems declined while neural networks gained prominence. NLP and speech recognition improved, with companies like IBM and Dragon Systems making key contributions. The 2000s saw advancements in robotics (e.g., Honda's ASIMO) and autonomous vehicles. Deep learning breakthroughs in the 2010s led to major improvements in image recognition and NLP. AI applications expanded across sectors including healthcare, education, military, and space exploration. Recent developments include virtual assistants, advanced language models like GPT-3, and Boston Dynamics' agile robots. These advancements have raised important ethical and societal questions as AI continues to integrate into various aspects of life and work.
...
The history of artificial intelligence (AI) is marked by a series of significant events and advancements, as well as notable failures within the field. Given the vastness of the subject, this review paper aims to catalog these milestones, emphasizing their importance rather than delving into extensive critical analysis. Magazines and Newspapers can be significant reliable sources for collecting additional historical events
...
The recent hype surrounding AI and the competition among major tech companies signals progress toward the development of true AI or Artificial General Intelligence (AGI). Therefore, the trajectory of this field is unpredictable, and the ideas and rules we currently employ may or may not remain sufficient or relevant in the future. Transformations, the financial wealth generated by AI, democratizing AI, guidelines and proper rules, and ethics in AI are some parameters to consider! 

AI has evolved from abstract philosophical ideas to mechanical systems, from vacuum tubes to transistors, and into the digital age, transforming from early PCs to the smartphones we carry today. As we continually push technological boundaries, there's an increasing possibility that machines could surpass human-level intelligence. AGI's defining traits like Self-teaching (Learning new skills independently), Problem-solving(Handling complex tasks like humans), and Adaptability(Adjusting to new challenges without pre-programming). Currently, AGI is hypothetical, with no systems achieving it yet. Research approaches include symbolic AI, neural networks, and robotics, but experts disagree on when AGI will emerge—ranging from 2027 to beyond 2300. While it promises advancements in areas like healthcare, AGI.
If achieved, AGI would fundamentally change how we interact with technology, potentially shifting global power dynamics, economies, and even our understanding of creativity, autonomy, and life itself. This evolution suggests that the world, as we know it today, will not remain the same. Thus, as we evolve AI, we must simultaneously address the societal ethical concerns regarding safety, control, and unintended consequences and ethical implications of this powerful technology.
